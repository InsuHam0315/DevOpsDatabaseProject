...
-- 5. JOBS (배송 작업 상세) 데이터 - PL/SQL 블록으로 JOB_ID를 변수에 저장
DECLARE
    v_job_id NUMBER;
BEGIN
    ...
    -- 7. ASSIGNMENTS (경로 노드 및 배차 상세) 데이터 - 생성된 JOB_ID 사용
